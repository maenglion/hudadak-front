(() => {
  ...
  const SCALE = {
    PM10: [
      ...
      { name: '보통',   max: 80,  color: { dark: ['#43A047', '#3BD497'], light: ['#629473', '#9ACEB9'] } },
      { name: '나쁨',   max: 150, color: { dark: ['#F57C00', '#FFB20B'], light: ['#F6AA5C', '#DDC472'] } },
      { name: '매우나쁨', max: 1000,color: { dark: ['#D32F2F', '#FF886B'], light: ['#C75959', '#BF8779'] } }
    ],
    PM25: [
      { name: '좋음',   max: 15,  color: { dark: ['#367BB8', '#7C9CC5'], light: ['#1e88e5', '#69AAFF'] } },
      { name: '보통',   max: 35,  color: { dark: ['#43A047', '#3BD497'], light: ['#629473', '#9ACEB9'] } },
      { name: '나쁨',   max: 75,  color: { dark: ['#F57C00', '#FFB20B'], light: ['#F6AA5C', '#DDC472'] } },
      { name: '매우나쁨', max: 1000,color: { dark: ['#D32F2F', '#FF886B'], light: ['#C75959', '#BF8779'] } }
    ]
  };
